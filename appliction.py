...
st.set_page_config(page_title='Patient_Survival_Prediction', page_icon="🏥", layout="wide", initial_sidebar_state='expanded')
...
def main():
    ...
    if submit:
        ...
        st.write(f"The predicted Patient is:  {survival}")
